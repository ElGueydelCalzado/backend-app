-- EGDC Inventory Management Database Setup
...
-- Create policies to allow full access (you can customize these based on your auth needs)
...
-- Sample data insertion (optional - remove if you want to start with empty tables)
-- This mimics the structure from your Google Sheets
INSERT INTO products (
    fecha, categoria, marca, modelo, color, talla, sku, ean, costo,
    shein_modifier, shopify_modifier, meli_modifier,
    inv_egdc, inv_fami, inv_bodega_principal, inv_tienda_centro, inv_tienda_norte, inv_tienda_sur, inv_online, inventory_total,
    shein, meli, shopify, tiktok, upseller, go_trendier, google_drive
) VALUES
    ('2024-01-15', 'Zapatos', 'Nike', 'Air Max 90', 'Blanco', '9', 'NIK-AM90-001', '1234567890123', 89.99, 1.10, 1.05, 1.15, 15, 8, 12, 5, 3, 2, 4, 49, true, true, true, false, false, false, true),
    ('2024-01-16', 'Zapatos', 'Adidas', 'Stan Smith', 'Verde', '8.5', 'ADI-SS-002', '2345678901234', 75.50, 1.20, 1.00, 1.10, 22, 12, 18, 8, 6, 4, 7, 77, true, true, false, true, false, false, true),
    ('2024-01-17', 'Botas', 'Timberland', '6-Inch Premium', 'Amarillo', '10', 'TIM-6IP-003', '3456789012345', 120.00, 1.00, 1.15, 1.05, 8, 5, 6, 2, 1, 1, 2, 25, false, true, true, false, true, false, false),
    ('2024-01-18', 'Sandalias', 'Havaianas', 'Brasil', 'Azul', '7', 'HAV-BR-004', '4567890123456', 25.99, 1.30, 1.25, 1.20, 50, 30, 25, 15, 10, 8, 12, 150, true, false, false, true, false, true, true),
    ('2024-01-19', 'Zapatos', 'Converse', 'Chuck Taylor All Star', 'Negro', '9.5', 'CON-CTA-005', '5678901234567', 55.00, 1.15, 1.10, 1.08, 18, 10, 14, 6, 4, 3, 5, 60, true, true, true, true, false, false, false),
    ('2024-01-20', 'Botas', 'Dr. Martens', '1460 Originals', 'Negro', '8', 'DRM-1460-006', '6789012345678', 150.00, 0.95, 1.00, 1.00, 6, 3, 4, 2, 1, 1, 1, 18, false, false, true, false, true, true, false),
    ('2024-01-21', 'Sandalias', 'Birkenstock', 'Arizona', 'Marrón', '9', 'BIR-AZ-007', '7890123456789', 95.00, 1.05, 1.20, 1.12, 12, 7, 10, 4, 3, 2, 3, 41, false, true, true, false, false, false, true),
    ('2024-01-22', 'Zapatos', 'Vans', 'Old Skool', 'Rojo', '8', 'VAN-OS-008', '8901234567890', 60.00, 1.25, 1.15, 1.18, 25, 15, 20, 10, 7, 5, 8, 90, true, true, false, true, true, false, true);

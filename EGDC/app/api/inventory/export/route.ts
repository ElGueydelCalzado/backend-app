...
export async function POST(request: NextRequest) {
  try {
    ...
    const exportColumns = [
      ...
      { key: 'inv_bodega_principal', label: 'Inv. Bodega Principal' },
      { key: 'inv_tienda_centro', label: 'Inv. Tienda Centro' },
      { key: 'inv_tienda_norte', label: 'Inv. Tienda Norte' },
      { key: 'inv_tienda_sur', label: 'Inv. Tienda Sur' },
      { key: 'inv_online', label: 'Inv. Online' },

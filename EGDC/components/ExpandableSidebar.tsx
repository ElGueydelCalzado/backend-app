          ...
          {expandedSections.has('productos') && (
            <div className="bg-gray-50 py-2">
              <button
                ...
                className={`w-full px-8 py-1 text-left text-sm transition-colors ${
              ...
              {loading ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="w-full px-8 py-1 text-left text-sm text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition-colors border-2 border-dashed border-gray-300 hover:border-gray-400 rounded-r-lg mr-2 mt-2"
                  >
                    <div className="flex items-center">
